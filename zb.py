    ...
    if payload:
        ...
        for keyword in keywords_to_obfuscate:
            ...
            if re.search(r'\b{}\b'.format(re.escape(keyword)), payload, re.IGNORECASE):
                # Generate a random MySQL version number between 50000 and 500
        ...
        char_replacements = {
            ',': f"/**{random.choice(['_','X'])}*//*!{random.randint(50000,500)}CHAR(44)*/", # Comma
            ...
            '=': f"/**{random.choice(['_','E'])}*//*!{random.randint(50000,5050)}CHAR(61)*/"  # Equals sign
        }
